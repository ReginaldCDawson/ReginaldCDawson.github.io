...
function createGreaterThanFilter(base) {
    ...
    var bases = base
function greaterThanFilter(value){
...
function createStartsWithFilter(startsWith) {
  ...
  return function startsWithFilter(string){
      var chars = string;
      if (startsWith.toLowerCase() === chars.charAt(0).toLowerCase()){
          return true;
      } else {
          return false;
      }
...
function createEndsWithFilter(endsWith) {
    ...
    return function endsWithFilter(string){
      var chars = string;
      if (endsWith.toLowerCase() === chars.charAt(chars.length - 1).toLowerCase()){
          return true;
      } else {
          return false;
      }
